    ...
    <div className="w-full  ">
      ...
      <div className="flex flex-col items-center bg-black text-white">
        <div className="bg-red">
          <h1 className="font-[1000] text-3xl md:text-4xl mx-2 pt-10  text-center md:leading-[45px] leading-10 tracking-wide">
            JOIN SHOPPING COMMUNITY TO GET <br />
            MONTHLY PROMO
          </h1>
          <p className="pt-6 pb-3 text-center text-[18px] tracking-wider">
            Type your email down below and be young wild generation
          </p>
        </div>
        <div className="bg-white text-black flex my-4 min-w-[30%] justify-between py-1 rounded-sm mb-8 mx-2">
          <input
            type="text"
